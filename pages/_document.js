  ...
  return (
    <Html lang="en">
      <Head>
        ...
        />
        <meta name="keywords" content="Tammy - Portfolio Template" />
        <meta name="description" content="Tammy - Portfolio Template" />
        {/* title */}
        <title>Tammy - Portfolio React NextJS Template</title>
        {/* Favicon */}
